<?php $pictures = new Pictures; ?>

<div class='row'>
	<div class='col-xs-12 text-center full-width'>
		<h4>Welcome to the website that celebrates the life and times of</h4>
		<h1>My Boy Dino</h1>
	</div>
</div>

<div class='row'>
	<div class='col-xs-12 offset-sm-2 col-sm-8 text-center'>
		<img src='<?=Pictures::HOME_THUMBS_URL.$pictures->getHomePic()?>' class='img-responsive fancy-image-border home-image full-width'>
	</div>
</div>
...
<div class='row'>
	<div class='col-xs-12 offset-sm-1 col-sm-10'>
		...
		<p>
			Not to say there were no challenges, there were issues with his digestion when I first got him, but after some help from
			our friendly neighborhood pet store, Sunflower Pet Supply in Tempe, AZ, he was soon in peak shape.
			He had more energy than anything I'd encountered up to that point, I immediately adjusted my schedule to wake up at 5 a.m.
			so we could go on a 45+ minute bike ride through our neighborhood near Meyer Park in Tempe, before I had to go to work.
			During the day my lady would walk him sometimes multiple times, and then when I returned from work we'd all go on a pack walk.
			We also taught him valuable things, like having a place to go when I tell him to "go lay down" because he's just standing there panting.
		</p>
		...
		<p>
			Currently he and I, and his little brother, Harley, are dwelling in the beautiful Pacific Northwest, 
			he loves the weather, and all the animals to watch, 
			and will lay for hours by the front stoop watching life go by our home in the hills.
		</p>
	</div>
</div>
